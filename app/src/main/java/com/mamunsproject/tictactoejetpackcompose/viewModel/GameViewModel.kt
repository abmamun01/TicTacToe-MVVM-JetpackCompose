package com.mamunsproject.tictactoejetpackcompose.viewModel
...
// checking victory for cross
    ...
    private fun checkForVictory(boardValue: BoardCellValue): Boolean {
        ...
        when {
            ...
            boardItems[2] == boardValue && boardItems[5] == boardValue && boardItems[6] == boardValue -> {
            ...
            boardItems[1] == boardValue && boardItems[5] == boardValue && boardItems[9] == boardValue -> {
                state = state.copy(victoryType = VictoryType.DIGONAL1)
                return true
            }

            boardItems[3] == boardValue && boardItems[5] == boardValue && boardItems[7] == boardValue -> {
                state = state.copy(victoryType = VictoryType.DIGONAL2)
                return true
            }
